    ...
    run: async function (client, message, args) {
        ...
        async function handleVideo(video, message, channel, playlist = false) {
            ...
            if (!serverQueue) {
                ...
                if (playlist) return;
                let thing = new MessageEmbed()
                    .setAuthor("Song has been added to queue", "https://cdn.discordapp.com/attachments/803882167193042975/812021018365394974/PINKmelody.png")
        ...
        async function play(guild, song) {
            ...
            let thing = new MessageEmbed()
                .setAuthor("Started Playing Music!", "https://cdn.discordapp.com/attachments/803882167193042975/812021018365394974/PINKmelody.png")
                .setThumbnail(song.img)
                .setColor("BLUE")
                .addField("Name", song.title, true)
                .addField("Requested by", song.req.tag, true)
